...
import { GetOrdersInput, GetOrdersOuput } from './dtos/get-orders.dto';
...
export class OrderService{
  ...
  async getOrders(user: User, { status }:GetOrdersInput): Promise<GetOrdersOuput>{
    try {
      let orders: Order[]
      if(user.role === UserRole.Client){
        ...
        // console.log(restaurants.map(restaurant => restaurant.orders))
